...
const AdminTrackOrders = lazy(() => import("@/pages/admin/AdminTrackOrders").then((m) => ({ default: m.AdminTrackOrders })));
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          >
            ...
            <Route path="track-orders" element={<Suspense fallback={<AdminFallback />}><AdminTrackOrders /></Suspense>} />
          </Route>
