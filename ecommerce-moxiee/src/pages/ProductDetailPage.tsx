...
import { cn, discountPercent, effectivePrice, formatCurrency, formatDate } from "@/lib/utils";
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-5 flex items-baseline gap-3">
            <span className="font-display text-3xl font-bold">{formatCurrency(price)}</span>
            {off > 0 && (
